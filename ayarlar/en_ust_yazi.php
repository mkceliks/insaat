...
<body>
    ...
    <form action="en_ust_yazi.php" method="post">
        <table style="margin-left: auto; margin-right: auto; border: 1px solid black;"> 
            <tr>
               ...
               <td colspan = '2'> <textarea name="en_ust_yazi" id="en_ust_yazi" cols="42" rows="25" ><?php echo $en_ust_yazi_icerik;  ?></textarea></td> 
            </tr>
    ...
    <?php 
        ...
        if (isset($_POST["en_ust_yazi"])){
            $yeni_icerik = $_POST["en_ust_yazi"];
            $sorgu = $conn->prepare("UPDATE icerikler SET icerik = ? WHERE icerik_ismi = 'en_ust_yazi'");
