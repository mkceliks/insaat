...
<body>
    ...
    ?>
    <!-- FORM OLUŞTUR-->
    <h3><center>Youtube linki değiştir</center></h3>
    <form action="youtube.php" method="post">
        <table style="margin-left: auto; margin-right: auto; border: 1px solid black;"> 
            <tr>

               <td colspan = '2'> <textarea name="youtube" id="youtube" cols="42" rows="25" ><?php echo $youtube_icerik;  ?></textarea></td> 
            </tr>
    ...
    <?php 
        ...
        if (isset($_POST["youtube"])){
            $yeni_icerik = $_POST["youtube"];
            $sorgu = $conn->prepare("UPDATE icerikler SET icerik = ? WHERE icerik_ismi = 'youtube'");
