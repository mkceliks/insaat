...
<body>
    ...
    ?>
    <!-- FORM OLUŞTUR-->
    <h3><center>Linkedin linki değiştir</center></h3>
    <form action="linkedin.php" method="post">
        <table style="margin-left: auto; margin-right: auto; border: 1px solid black;"> 
            <tr>

               <td colspan = '2'> <textarea name="linkedin" id="linkedin" cols="42" rows="25" ><?php echo $linkedin_icerik;  ?></textarea></td> 
            </tr>
    ...
    <?php 
        ...
        if (isset($_POST["linkedin"])){
            $yeni_icerik = $_POST["linkedin"];
            $sorgu = $conn->prepare("UPDATE icerikler SET icerik = ? WHERE icerik_ismi = 'linkedin'");
