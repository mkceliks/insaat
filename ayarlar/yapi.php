...
<body>
    ...
    ?>
    <!-- FORM OLUŞTUR-->
    <h3><center>Yapı değiştir</center></h3>
    <form action="yapi.php" method="post">
        <table style="margin-left: auto; margin-right: auto; border: 1px solid black;"> 
            <tr>

               <td colspan = '2'> <textarea name="yapi" id="yapi" cols="42" rows="25" ><?php echo $yapi_icerik;  ?></textarea></td>
            </tr>
    ...
    <?php 
        ...
        if (isset($_POST["yapi"])){
            $yeni_icerik = $_POST["yapi"];
            
            $sorgu = $conn->prepare("UPDATE icerikler SET icerik = ? WHERE icerik_ismi = 'yapi'");
