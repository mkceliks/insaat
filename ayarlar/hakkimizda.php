...
<body>
    ...
    ?>
    <!-- FORM OLUŞTUR-->
    <h3><center>Hakkımızda yazısını değiştir</center></h3>
    <form action="hakkimizda.php" method="post">
        <table style="margin-left: auto; margin-right: auto; border: 1px solid black;"> 
            <tr>

               <td colspan = '2'> <textarea name="hakkimizda" id="hakkimizda" cols="42" rows="25" ><?php echo $hakkimizda_icerik;  ?></textarea></td> 
            </tr>
