...
<body>
    ...
    ?>
    <!-- FORM OLUŞTUR-->
    <h3><center>Malzeme değiştir</center></h3>
    <form action="malzeme.php" method="post">
        <table style="margin-left: auto; margin-right: auto; border: 1px solid black;"> 
            <tr>

               <td colspan = '2'> <textarea name="malzeme" id="malzeme" cols="42" rows="25" ><?php echo $malzeme_icerik;  ?></textarea></td>
            </tr>
    ...
    <?php 
        ...
        if (isset($_POST["malzeme"])){
            $yeni_icerik = $_POST["malzeme"];
            
            $sorgu = $conn->prepare("UPDATE icerikler SET icerik = ? WHERE icerik_ismi = 'malzeme'");
