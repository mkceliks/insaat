...
<html lang="en">
   ...
   <!-- Site Metas -->
   <title>Koyukan İnşaat Ek Servisler</title>
   ...
   <body class="building_version" data-spy="scroll" data-target=".header">
         ...
         <nav class="megamenu navbar navbar-default" data-spy="affix">
            ...
            <div class="container">
               <div style="height: 100px;" class="navbar-header">
                  ...
                  <a class="navbar-brand" href="index.php"><img style="height: 200%;" src="images/logokk.png" alt="image"><span>Koyukan İnşaat</span></a>
               </div>
               <div style="margin-top: 28px;" id="navbar" class="navbar-collapse collapse">
                  <ul class="nav navbar-nav navbar-right">
                     ...
                     <li><a data-scroll href="http://localhost/githubdan_gelen/#iletisim">BİZİMLE İLETİŞİME GEÇİN</a></li>
                  </ul>
               </div>
            </div>
         </nav>
      ...
      <?php 
         ...
         $sql1 = "SELECT * FROM servisler WHERE servis_id='$servis_id'";
         $result1 = mysqli_query($conn, $sql1);
         $servis = mysqli_fetch_assoc($result1);
      ?>
      
      <div id="home" class="parallax" data-stellar-background-ratio="0.4" style="background-image:url('images/servisler/<?php echo $servis['servis_arkaplan']; ?>');">
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-4">
                  <div class="widget widget_text">
                     ...
                     <div class="textwidget">
                        <a class="navbar-brand" href="index-building.html"><img style="height: 200%;" src="images/logokk.png" alt="image"><span>KOYUKAN İNŞAAT</span></a><br><br><br>
                        <p><?php 
