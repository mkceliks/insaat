         ...
         <nav class="megamenu navbar navbar-default" data-spy="affix">
            ...
            <div class="container">
               <div style="height: 100px;" class="navbar-header">
                  ...
                  <a class="navbar-brand" href="index.php"><img style="height: 200%;" src="images/logokk.png" alt="image"><span style="margin-top: 40px;">Koyukan İnşaat</span></a>
               </div>
               <div style="margin-top: 35px;" id="navbar" class="navbar-collapse collapse">
